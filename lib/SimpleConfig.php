 ...
 * 
 * Slights mods
 * @author Theodore R. Smith - http://www.phpexperts.pro/
 * @copyright 2010 Theodore R. Smith
 */
 ...
 * @since Sun Jan 17 03:29:42 GMT 2010
 */
class SimpleConfig extends ArrayObject implements Countable, IteratorAggregate
{
    /**
     * instance
     * @var SimpleConfig
     ...
     */
    public static function setConfig($filePath) 
    {
        // Make sure instance doesn't exist yet.
        if (self::$_instance !== null)
        {
            throw new LogicException('You need to set the path before calling '. __CLASS__ .'::getInstance() method', 0);
        }
        else
        {
